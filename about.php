    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/lgfrozen2.png" class="w-50" alt="logo" />
        </a>
        <button
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">CRF FROZEN FOOD</h1>
              <h5 class="">Toko Frozen Food Terbaik</h5>
              <a
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">CRF FROZEN</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>CRF FROZEN FOOD MERUPAKAN TEMPAT MAKANAN RINGAN TERBAIK</p>
            </div>
          </div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <h5>Visi</h5>
                <p>Menjadi perusahaan Frozen Food terbaik seindonesia yang akan menghasilkan Makanan serta produk berkualitas tinggi</p>
            </div>
            <div class="col-md-6">
                <h5>Misi</h5>
                <p>Meningkatkan daya saing industri Makanan Frozen dan berusaha menjaminkan kualitas</p>
            </div>
          </div>
        </div>
      </section>
