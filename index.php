    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/lgfrozen1.png" class="w-50" alt="logo" />
        </a>
        <button
      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">CRF FROZEN</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
               CRF FROZEN FOOD merupakan tempat penjualan makanan frozen yang sehat dan segar
              </p>
                ...
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        <div class="title-text">Harga Terjamin</div>
                        <div class="subtitle-text">
                          Kami sudah pasti termurah sedunia
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">GRATIS ONGKIR</div>
                        <div class="subtitle-text">
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img src="assets/images/hll.png" class="w-100" alt="" />
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">100% Halal</div>
                        <div class="subtitle-text">
                          Dicek langsung oleh ahliislam, dan terjamin halal
                        </div>
                      </div>
                    </div>
                  </div>
